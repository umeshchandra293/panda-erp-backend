...
public class RawMaterialMapper extends BaseMapper {
    ...
    public BaseEntity toEntity(Object model, Object entity, boolean isNew) {
        ...
        if (mat.getCategory() != null) e.setCategory(mat.getCategory().name());
        if (mat.getUom() != null)      e.setUom(mat.getUom().name());
    ...
    public Object toModel(Object entity) {
        ...
        if (e.getCategory() != null) {
            try {
                ...
                mat.setCategory(RawMaterial.CategoryEnum.OTHER);
            }
        }
        ...
        if (e.getUom() != null) {
            try {
                ...
                mat.setUom(RawMaterial.UomEnum.KG);
            }
        }
