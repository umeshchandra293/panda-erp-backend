...
public class ProductDiscountRepository extends ParentRepositoryImpl {
    ...
    private static final String TABLE_NAME_KEY = "discount_id";

    @Autowired private ProductDiscountRowMapper productDiscountRowMapper;

    @SuppressWarnings("unchecked")
    @Override protected Class<ProductDiscountEntity> getEntityClass() { return ProductDiscountEntity.class; }
    @SuppressWarnings("unchecked")
    @Override protected BaseRowMapper<ProductDiscountEntity> getRowMapper() { return productDiscountRowMapper; }
