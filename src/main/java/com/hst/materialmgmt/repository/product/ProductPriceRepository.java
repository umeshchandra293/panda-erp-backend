...
public class ProductPriceRepository extends ParentRepositoryImpl {
	...
	@Autowired 
  	private ProductPriceRowMapper productPriceRowMapper;

    @SuppressWarnings("unchecked")
    @Override
    protected Class<ProductPriceEntity> getEntityClass() {
        return ProductPriceEntity.class;
    }

    @SuppressWarnings("unchecked")
    @Override
    protected BaseRowMapper<ProductPriceEntity> getRowMapper() {
        return productPriceRowMapper;
    }
