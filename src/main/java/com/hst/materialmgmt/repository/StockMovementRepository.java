...
public class StockMovementRepository extends ParentRepositoryImpl {
    ...
    // GREATEST(0, ...) ensures stock_on_hand never returns negative.
    // If data is corrupted (more outbound than inbound), it returns 0
    // and the frontend shows a CRITICAL alert — not a negative number.
